...
export const homeLore: Lore = [
  ...
  {
    h2: "Historia y Fundación de Comi Dólar",
  ...
  {
    h2: "Participación en Comi Dólar",
  ...
  {
    h2: "Visión y Futuro de Comi Dólar",
...
export const wspLore: Lore = [
    {
        h2: "Grupo de Whatsapp de Comi Dólar",
