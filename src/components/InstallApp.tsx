...
export default function InstallApp() {
  ...
  return (
    <div className="relative">
      ...
      {showPopover && (
        <div
          className="absolute left-1/2 transform -translate-x-1/2 mt-3 bg-green-500 text-white p-2 rounded-lg shadow-lg w-42 text-center text-xs 
                    opacity-0 translate-y-[-10px] animate-slide-in"
        >
          <span>¡Instalá la APP de ComiDólar para acelerar tus consultas!</span>
          <button
            onClick={closePopover}
            className="absolute top-1 cursor-pointer right-2 text-white text-lg"
          >
            ✕
          </button>
